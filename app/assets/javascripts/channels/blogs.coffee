...
#  Function called on tubolinks:load
  ...
  if comments.length > 0
    ...
    received: (data) -> # On recied perform the function
      ...
      # Checkout blogs_channel.rb for where this method is created
  ...
  $('#new_comment').submit (e) ->
    ...
    if $.trim(textarea.val()).length > 1
      ...
      # This line will
      # 1. Call the app channel and method send_comment defined in app/channels/blogs_channel.rb
      # 2. Reset the text area to be a blank string
